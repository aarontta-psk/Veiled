...
new Phaser.Game({
    ...
    scene: [Boot, MainMenu, Options, levelSelector, Level0, Level1, Level2, InfoLevel, testEvent, anotherTestEvent, deathEvent_0, maxFaithEvent_0, PauseScene, painterEvent_0, painterEvent_1, painterEvent_2, doctorEvent_0,
