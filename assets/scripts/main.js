...
import {testEvent, anotherTestEvent, deathEvent_0, painterEvent_0, painterEvent_1, painterEvent_2, doctorEvent_0, doctorEvent_1
...
new Phaser.Game({
    ...
    scene: [Boot, MainMenu, Options, GameScene, InfoLevel, testEvent, anotherTestEvent, deathEvent_0, PauseScene, painterEvent_0, painterEvent_1, painterEvent_2, doctorEvent_0,
